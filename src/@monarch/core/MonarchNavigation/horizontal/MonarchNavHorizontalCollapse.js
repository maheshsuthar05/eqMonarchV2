...
import MonarchNavItem from '../MonarchNavItem';
...
function MonarchNavHorizontalCollapse(props) {
						...
						<div ref={ref}>
							...
							>
								...
								<ListItemText
									...
									classes={{ primary: 'text-12' }}
								/>

								{item.badge && <MonarchNavBadge className="mx-4" badge={item.badge} />}
...
MonarchNavHorizontalCollapse.propTypes = {
...
MonarchNavHorizontalCollapse.defaultProps = {};

const NavHorizontalCollapse = withRouter(React.memo(MonarchNavHorizontalCollapse));
