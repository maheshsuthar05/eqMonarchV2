...
function MonarchNavHorizontalLink(props) {
...
MonarchNavHorizontalLink.propTypes = {
...
MonarchNavHorizontalLink.defaultProps = {};

const NavHorizontalLink = withRouter(React.memo(MonarchNavHorizontalLink));
