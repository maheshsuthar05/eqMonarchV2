...
function MonarchNavHorizontalGroup(props) {
...
MonarchNavHorizontalGroup.propTypes = {
...
MonarchNavHorizontalGroup.defaultProps = {};

const NavHorizontalGroup = withRouter(React.memo(MonarchNavHorizontalGroup));
