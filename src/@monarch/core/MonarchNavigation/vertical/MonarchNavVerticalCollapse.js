...
function MonarchNavVerticalCollapse(props) {
...
MonarchNavVerticalCollapse.propTypes = {
...
MonarchNavVerticalCollapse.defaultProps = {};

const NavVerticalCollapse = withRouter(React.memo(MonarchNavVerticalCollapse));
