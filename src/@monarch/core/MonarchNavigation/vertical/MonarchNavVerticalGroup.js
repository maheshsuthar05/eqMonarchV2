...
function MonarchNavVerticalGroup(props) {
...
MonarchNavVerticalGroup.propTypes = {
...
MonarchNavVerticalGroup.defaultProps = {};

const NavVerticalGroup = withRouter(React.memo(MonarchNavVerticalGroup));
