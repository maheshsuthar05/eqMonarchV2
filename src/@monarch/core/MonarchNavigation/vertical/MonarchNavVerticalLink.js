...
function MonarchNavVerticalLink(props) {
...
MonarchNavVerticalLink.propTypes = {
...
MonarchNavVerticalLink.defaultProps = {};

const NavVerticalLink = withRouter(React.memo(MonarchNavVerticalLink));
