...
import MonarchPageSimpleHeader from './MonarchPageSimpleInnerHeader';
import MonarchPageSimpleSidebar from './MonarchPageSimpleInnerSidebar';
...
const MonarchPageSimpleInner = React.forwardRef((props, ref) => {
...
MonarchPageSimpleInner.propTypes = {
...
MonarchPageSimpleInner.defaultProps = {};

export default React.memo(MonarchPageSimpleInner);
