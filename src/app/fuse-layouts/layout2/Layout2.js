...
import MonarchSimpleBackdrop from '@monarch/core/MonarchBackdrop';
import MonarchDialog from '@monarch/core/MonarchDialog';
...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    overflow: 'hidden',
    '&.boxed': {
      maxWidth: theme.layoutMaxWidth.boxed,
      margin: '0 auto'
    },
    '&.container': {
      '& .container': {
        maxWidth: theme.layoutMaxWidth.container,
        width: '100%',
        margin: '0 auto'
      },
      '& .navigation': {}
...
function Layout2(props) {
  ...
  return (
    <AppContext.Consumer>
      {({ routes }) => (
        <div id="layout" className={clsx(classes.root, config.mode)}>
